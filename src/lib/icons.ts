...
export const Sparkles = createIcon(
  "m9 12 2 2 4-4M21 12c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1zM3 12c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1zM12 21c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1zM12 3c.552 0 1-.448 1-1s-.448-1-1-1-1 .448-1 1 .448 1 1 1z"
);
...
export const Github = createIcon(
  "M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 4 5 4 5 4c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 11c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4M9 18c-4.51 2-5-2-7-2"
);
export const Facebook = createIcon(
  "M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"
);
export const Instagram = createIcon(
  "M2 7c0-2.761 2.239-5 5-5h10c2.761 0 5 2.239 5 5v10c0 2.761-2.239 5-5 5H7c-2.761 0-5-2.239-5-5V7zm14 4.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37zM17.5 6.5h.01",
  "0 0 24 24"
);
...
export const Search = createIcon(
  "m21 21-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0z"
);
export const RefreshCw = createIcon(
  "M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16M21 8v3h-3M3 16v-3h3"
);

// Dashboard icons
export const LayoutDashboard = createIcon("M7 3v18M3 7h18M3 17h4M21 7v10");
export const ImageIcon = createIcon(
  "M15 8h.01M3 6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6zM8 14l2.5-2.5L13 14l4.5-4.5L21 13"
);
...
export const Sun = createIcon(
  "M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 6.34l-1.41-1.41M19.07 19.07l-1.41-1.41"
);
...
export const LayoutPanelTop = createIcon(
  "M3 3h18v7H3zM3 14h8v7H3zM15 14h6v7h-6z"
);
...
export const Replace = createIcon(
  "M14 4a4 4 0 0 1 0 8M10 20a4 4 0 0 1 0-8M16 12h6M21 9l3 3-3 3M2 12h6M5 15l-3-3 3-3"
);
...
export const GripVertical = createIcon(
  "M9 12h.01M15 12h.01M9 16h.01M15 16h.01M9 8h.01M15 8h.01"
);
export const PanelLeft = createIcon(
  "M14 6v12M14 2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10M20 6v12"
);
