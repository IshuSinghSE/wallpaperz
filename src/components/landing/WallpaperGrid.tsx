...
// Sample wallpaper grid images - replace with your actual wallpapers
const wallpaperItems = [
  { id: 1, src: "/placeholder.svg", alt: "Nature wallpaper" },
  { id: 2, src: "/placeholder.svg", alt: "Abstract wallpaper" },
  { id: 3, src: "/placeholder.svg", alt: "Technology wallpaper" },
  { id: 4, src: "/placeholder.svg", alt: "Space wallpaper" },
  { id: 5, src: "/placeholder.svg", alt: "City wallpaper" },
  { id: 6, src: "/placeholder.svg", alt: "Animals wallpaper" },
];
...
const WallpaperGrid = () => {
  ...
  return (
    <section className="py-20 relative" id="wallpapers">
